...
RSpec.describe "pluralization for fr-FR" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "fr-FR", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "fr-FR")
