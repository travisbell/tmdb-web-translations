...
RSpec.describe "pluralization for ko-KR" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "ko-KR", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "ko-KR")
