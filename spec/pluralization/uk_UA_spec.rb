...
RSpec.describe "pluralization for uk-UA" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "uk-UA", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "uk-UA")
