...
RSpec.describe "pluralization for sv-SE" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "sv-SE", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "sv-SE")
