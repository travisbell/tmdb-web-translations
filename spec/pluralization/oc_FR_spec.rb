...
RSpec.describe "pluralization for oc-FR" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "oc-FR", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "oc-FR")
