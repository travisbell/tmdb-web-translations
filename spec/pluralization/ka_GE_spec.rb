...
RSpec.describe "pluralization for ka-GE" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "ka-GE", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "ka-GE")
