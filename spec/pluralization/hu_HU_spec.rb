...
RSpec.describe "pluralization for hu-HU" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "hu-HU", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "hu-HU")
