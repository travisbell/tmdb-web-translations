...
RSpec.describe "pluralization for id-ID" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "id-ID", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "id-ID")
