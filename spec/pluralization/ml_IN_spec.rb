...
RSpec.describe "pluralization for ml-IN" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "ml-IN", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "ml-IN")
