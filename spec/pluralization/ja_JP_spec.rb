...
RSpec.describe "pluralization for ja-JP" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "ja-JP", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "ja-JP")
