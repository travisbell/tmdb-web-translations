...
RSpec.describe "pluralization for pt-PT" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "pt-PT", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "pt-PT")
