...
RSpec.describe "pluralization for da-DK" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "da-DK", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "da-DK")
