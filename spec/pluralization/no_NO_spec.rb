...
RSpec.describe "pluralization for no-NO" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "no-NO", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "no-NO")
