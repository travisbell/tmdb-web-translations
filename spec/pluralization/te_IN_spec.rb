...
RSpec.describe "pluralization for te-IN" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "te-IN", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "te-IN")
