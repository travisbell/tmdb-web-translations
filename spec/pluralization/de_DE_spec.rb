...
RSpec.describe "pluralization for de-DE" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "de-DE", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "de-DE")
