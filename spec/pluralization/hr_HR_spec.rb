...
RSpec.describe "pluralization for hr-HR" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "hr-HR", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "hr-HR")
