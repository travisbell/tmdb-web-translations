...
RSpec.describe "pluralization for af-ZA" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "af-ZA", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "af-ZA")
