...
RSpec.describe "pluralization for bg-BG" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "bg-BG", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "bg-BG")
