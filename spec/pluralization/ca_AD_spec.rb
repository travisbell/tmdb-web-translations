...
RSpec.describe "pluralization for ca-AD" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "ca-AD", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "ca-AD")
