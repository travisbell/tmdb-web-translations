...
RSpec.describe "pluralization for so-SO" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "so-SO", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "so-SO")
