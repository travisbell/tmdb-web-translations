...
RSpec.describe "pluralization for kk-KZ" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "kk-KZ", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "kk-KZ")
