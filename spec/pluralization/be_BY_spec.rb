...
RSpec.describe "pluralization for be-BY" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "be-BY", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "be-BY")
