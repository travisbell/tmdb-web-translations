...
RSpec.describe "pluralization for nb-NO" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "nb-NO", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "nb-NO")
