...
RSpec.describe "pluralization for en-AU" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "en-AU", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "en-AU")
