...
RSpec.describe "pluralization for en-CA" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "en-CA", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "en-CA")
