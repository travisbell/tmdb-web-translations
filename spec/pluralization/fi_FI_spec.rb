...
RSpec.describe "pluralization for fi-FI" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "fi-FI", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "fi-FI")
