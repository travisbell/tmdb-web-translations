...
RSpec.describe "pluralization for ku-TR" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "ku-TR", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "ku-TR")
