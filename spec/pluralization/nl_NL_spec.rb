...
RSpec.describe "pluralization for nl-NL" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "nl-NL", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "nl-NL")
