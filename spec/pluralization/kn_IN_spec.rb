...
RSpec.describe "pluralization for kn-IN" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "kn-IN", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "kn-IN")
