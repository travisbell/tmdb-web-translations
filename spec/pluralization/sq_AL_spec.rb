...
RSpec.describe "pluralization for sq-AL" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "sq-AL", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "sq-AL")
