...
RSpec.describe "pluralization for ru-RU" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "ru-RU", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "ru-RU")
