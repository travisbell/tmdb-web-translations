...
RSpec.describe "pluralization for es-MX" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "es-MX", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "es-MX")
