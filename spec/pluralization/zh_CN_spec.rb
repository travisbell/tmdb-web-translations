...
RSpec.describe "pluralization for zh-CN" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "zh-CN", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "zh-CN")
