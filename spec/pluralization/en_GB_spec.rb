...
RSpec.describe "pluralization for en-GB" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "en-GB", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "en-GB")
