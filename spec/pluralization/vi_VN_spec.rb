...
RSpec.describe "pluralization for vi-VN" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "vi-VN", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "vi-VN")
