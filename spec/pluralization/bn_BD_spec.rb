...
RSpec.describe "pluralization for bn-BD" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "bn-BD", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "bn-BD")
