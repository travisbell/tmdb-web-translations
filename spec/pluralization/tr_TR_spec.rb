...
RSpec.describe "pluralization for tr-TR" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "tr-TR", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "tr-TR")
