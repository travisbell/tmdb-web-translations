...
RSpec.describe "pluralization for es-CL" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "es-CL", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "es-CL")
