...
RSpec.describe "pluralization for el-GR" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "el-GR", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "el-GR")
