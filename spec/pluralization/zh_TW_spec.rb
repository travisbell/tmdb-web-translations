...
RSpec.describe "pluralization for zh-TW" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "zh-TW", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "zh-TW")
