...
RSpec.describe "pluralization for it-IT" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "it-IT", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "it-IT")
