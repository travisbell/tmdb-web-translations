...
RSpec.describe "pluralization for fa-IR" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "fa-IR", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "fa-IR")
