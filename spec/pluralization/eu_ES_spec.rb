...
RSpec.describe "pluralization for eu-ES" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "eu-ES", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "eu-ES")
