...
RSpec.describe "pluralization for ar-EG" do
  subject(:rule) { I18n.t(:"i18n.plural.rule", locale: "ar-EG", resolve: false) }

  it "has the correct plural keys" do
    plural_keys = I18n.t("i18n.plural.keys", locale: "ar-EG")
