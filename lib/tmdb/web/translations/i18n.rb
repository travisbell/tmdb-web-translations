  ...
  module Web
    class Translations
      DEFAULT_MAPPING = {
        ...
        "it" => "it-IT", "ja" => "ja-JP", "ka" => "ka-GE", "kk" => "kk-KZ", "kn" => "kn-IN", "ko" => "ko-KR",
        "ku" => "ku-TR", "ky" => "ky-KG", "lt" => "lt-LT", "lv" => "lv-LV", "ml" => "ml-IN", "mr" => "mr-IN",
        "ms" => "ms-MY", "nb" => "nb-NO", "ne" => "ne-NP", "nl" => "nl-NL", "no" => "no-NO", "oc" => "oc-FR",
        "pa" => "pa-IN", "pl" => "pl-PL", "pt" => "pt-PT", "ro" => "ro-RO", "ru" => "ru-RU", "si" => "si-LK",
        "sk" => "sk-SK", "sl" => "sl-SI", "so" => "so-SO", "sq" => "sq-AL", "sr" => "sr-RS", "sv" => "sv-SE",
        "sw" => "sw-TZ", "ta" => "ta-IN", "te" => "te-IN", "tl" => "tl-PH", "th" => "th-TH", "tr" => "tr-TR",
        "uk" => "uk-UA", "ur" => "ur-PK", "uz" => "uz-UZ", "vi" => "vi-VN", "zh" => "zh-CN", "zu" => "zu-ZA"
      }.freeze

      DEFAULT_COUNTRY_MAPPING = {
        "AA" => "aa-AA", "AB" => "ab-AB", "AE" => "ae-AE", "AK" => "ak-AK", "AM" => "hy-AM", "AN" => "an-AN",
        ...
        "HO" => "ho-HO", "HR" => "hr-HR", "HT" => "ht-HT", "HU" => "hu-HU", "HZ" => "hz-HZ", "IA" => "ia-IA", "ID" => "id-ID",
        "IG" => "ig-IG", "II" => "ii-II", "IK" => "ik-IK", "IO" => "io-IO", "IS" => "is-IS", "VA" => "it-VA", "IT" => "it-IT",
        "IU" => "iu-IU", "JP" => "ja-JP", "JV" => "jv-JV", "GE" => "ka-GE", "KG" => "kg-KG", "KI" => "ki-KI", "KJ" => "kj-KJ",
        "KZ" => "kk-KZ", "KL" => "kl-KL", "KM" => "km-KM", "KR" => "ko-KR", "KS" => "ks-KS", "KV" => "kv-KV", "KW" => "kw-KW",
        "LA" => "la-LA", "LB" => "lb-LB", "LG" => "lg-LG", "LI" => "li-LI", "LN" => "ln-LN", "LO" => "lo-LO", "LT" => "lt-LT",
        "LU" => "lu-LU", "LV" => "lv-LV", "MG" => "mg-MG", "MH" => "mh-MH", "MI" => "mi-MI", "MK" => "mk-MK", "MN" => "mn-MN",
        "MO" => "mo-MO", "SG" => "ms-SG", "MY" => "ms-MY", "MT" => "mt-MT", "NA" => "na-NA", "NO" => "nb-NO", "ND" => "nd-ND",
        "NG" => "ng-NG", "NL" => "nl-NL", "BE" => "nl-BE", "NN" => "nn-NN", "NP" => "ne-NP", "NR" => "nr-NR", "NV" => "nv-NV",
        "NY" => "ny-NY", "OJ" => "oj-OJ", "OM" => "om-OM", "OR" => "or-OR", "OS" => "os-OS", "PI" => "pi-PI", "PL" => "pl-PL",
        "PS" => "ps-PS", "AO" => "pt-AO", "BR" => "pt-BR", "PT" => "pt-PT", "MZ" => "pt-MZ", "QU" => "qu-QU", "RM" => "rm-RM",
        "RN" => "rn-RN", "MD" => "ro-MD", "RO" => "ro-RO", "RU" => "ru-RU", "RW" => "rw-RW", "SC" => "sc-SC", "SD" => "sd-SD",
        "SE" => "se-SE", "SH" => "sh-SH", "LK" => "si-LK", "SK" => "sk-SK", "SI" => "sl-SI", "SM" => "sm-SM", "SN" => "sn-SN",
        "SO" => "so-SO", "XK" => "sq-XK", "AL" => "sq-AL", "RS" => "sr-RS", "ME" => "sr-ME", "SS" => "ss-SS", "ST" => "st-ST",
        "SU" => "su-SU", "TZ" => "sw-TZ", "TG" => "tg-TG", "TH" => "th-TH", "TI" => "ti-TI", "TK" => "tk-TK", "PH" => "tl-PH",
        "TN" => "tn-TN", "TO" => "to-TO", "TR" => "tr-TR", "TS" => "ts-TS", "TT" => "tt-TT", "TW" => "tw-TW", "TY" => "ty-TY",
        "UG" => "ug-UG", "UA" => "uk-UA", "PK" => "ur-PK", "UZ" => "uz-UZ", "VE" => "ve-VE", "VN" => "vi-VN", "VO" => "vo-VO",
        "WA" => "wa-WA", "WO" => "wo-WO", "XH" => "xh-XH", "XX" => "xx-XX", "YI" => "yi-YI", "YO" => "yo-YO", "CN" => "zh-CN",
        "HK" => "zh-HK", "ZA" => "af-ZA"
      }.freeze

      IGNORED_TRANSLATIONS = [
        "ar-BH", "ar-EG", "ar-IQ", "ar-JO", "ar-LY", "ar-MA", "ar-QA", "ar-YE", "ar-TD", "br-FR", "ca-AD",
        "en-AG", "el-CY", "en-AG", "en-AU", "en-BB", "en-BZ", "en-CA", "en-CM", "en-GB", "en-GG", "en-GH",
        "en-GI", "en-GY", "en-IE", "en-JM", "en-KE", "en-LC", "en-MW", "en-NZ", "en-PG", "en-TC", "en-ZM",
        "en-ZW", "es-AR", "es-CL", "es-DO", "es-EC", "es-GT", "es-GQ", "es-HN", "es-NI", "es-PA", "es-PE",
        "es-PY", "es-SV", "es-UY", "fr-BF", "fr-CD", "fr-CI", "fr-GF", "fr-GP", "fr-MC", "fr-ML", "fr-MU",
        "fr-PF", "it-VA", "pt-AO", "pt-MZ", "ro-MD", "sr-ME", "sq-XK"
      ].freeze
      ...
      LANGUAGE_CODES = [
        ...
        "lo", "lt", "lu", "lv", "mg", "mh", "mi", "mk", "ml", "mn", "mo", "mr", "ms", "mt", "my", "na", "nb", "nd", "ne",
        "ng", "nl", "nn", "no", "nr", "nv", "ny", "oc", "oj", "om", "or", "os", "pa", "pi", "pl", "ps", "pt", "qu", "rm",
        "rn", "ro", "ru", "rw", "sa", "sc", "sd", "se", "sg", "sh", "si", "sk", "sl", "sm", "sn", "so", "sq", "sr", "ss",
        "st", "su", "sv", "sw", "ta", "te", "tg", "th", "ti", "tk", "tl", "tn", "to", "tr", "ts", "tt", "tw", "ty", "ug",
        "uk", "ur", "uz", "ve", "vi", "vo", "wa", "wo", "xh", "xx", "yi", "yo", "za", "zh", "zu"
      ].freeze
      ...
      class << self
        ...
        def supported_rtl?(language)
          RTL_LANGUAGE_CODES.include?(language)
        end

        def supported_iso_639_1
          DEFAULT_MAPPING.keys
        end

        def supported_iso_639_1_path
